...
public class UInt_Vect : global::System.IDisposable, global::System.Collections.IEnumerable
    , global::System.Collections.Generic.IEnumerable<uint>
 {
  ...
  public UInt_Vect(SWIGTYPE_p_std__vectorT_unsigned_int_t other) : this(RDKFuncsPINVOKE.new_UInt_Vect__SWIG_1(SWIGTYPE_p_std__vectorT_unsigned_int_t.getCPtr(other)), true) {
    if (RDKFuncsPINVOKE.SWIGPendingException.Pending) throw RDKFuncsPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void AddRange(SWIGTYPE_p_std__vectorT_unsigned_int_t values) {
    RDKFuncsPINVOKE.UInt_Vect_AddRange(swigCPtr, SWIGTYPE_p_std__vectorT_unsigned_int_t.getCPtr(values));
    if (RDKFuncsPINVOKE.SWIGPendingException.Pending) throw RDKFuncsPINVOKE.SWIGPendingException.Retrieve();
  }

  public SWIGTYPE_p_std__vectorT_unsigned_int_t GetRange(int index, int count) {
    global::System.IntPtr cPtr = RDKFuncsPINVOKE.UInt_Vect_GetRange(swigCPtr, index, count);
    SWIGTYPE_p_std__vectorT_unsigned_int_t ret = (cPtr == global::System.IntPtr.Zero) ? null : new SWIGTYPE_p_std__vectorT_unsigned_int_t(cPtr, true);
    if (RDKFuncsPINVOKE.SWIGPendingException.Pending) throw RDKFuncsPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void InsertRange(int index, SWIGTYPE_p_std__vectorT_unsigned_int_t values) {
    RDKFuncsPINVOKE.UInt_Vect_InsertRange(swigCPtr, index, SWIGTYPE_p_std__vectorT_unsigned_int_t.getCPtr(values));
    if (RDKFuncsPINVOKE.SWIGPendingException.Pending) throw RDKFuncsPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public static SWIGTYPE_p_std__vectorT_unsigned_int_t Repeat(uint value, int count) {
  ...
  public void SetRange(int index, SWIGTYPE_p_std__vectorT_unsigned_int_t values) {
    RDKFuncsPINVOKE.UInt_Vect_SetRange(swigCPtr, index, SWIGTYPE_p_std__vectorT_unsigned_int_t.getCPtr(values));
    if (RDKFuncsPINVOKE.SWIGPendingException.Pending) throw RDKFuncsPINVOKE.SWIGPendingException.Retrieve();
  }

  public bool equals(SWIGTYPE_p_std__vectorT_unsigned_int_t o) {
    bool ret = RDKFuncsPINVOKE.UInt_Vect_equals(swigCPtr, SWIGTYPE_p_std__vectorT_unsigned_int_t.getCPtr(o));
    if (RDKFuncsPINVOKE.SWIGPendingException.Pending) throw RDKFuncsPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
